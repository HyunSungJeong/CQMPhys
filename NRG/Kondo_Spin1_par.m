function Kondo_Spin1_par (varargin)
  ...
  for it = 1:num_jobs
    if ~exist(['/data/',getenv('USER'),'/Kondo_Spin1/',partot(it).JobName,'_Nkeep=',sprintf('%.15g',Nkeep)],'dir')
      mkdir(['/data/',getenv('USER'),'/Kondo_Spin1/',partot(it).JobName,'_Nkeep=',sprintf('%.15g',Nkeep)]);
    end
  end
  ...
  parfn = ['Kondo_Spin1_par_J0=',J0s,'_T=',Ts];
