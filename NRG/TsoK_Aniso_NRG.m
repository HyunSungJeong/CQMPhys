    ...
    try % in case of bug
        ...
        if getCorr
            ...
            for site = 0:N-2
                ...
                Sp_corrT = contract(Sp_corr_Left,'!1',NRGDATA.AT,'!2');
                Sp_corrT = contract(Sp_corrT,conj(Wilson_sp));
                Sp_corrT = contract(NRGDATA.AT,'!2*',Sp_corrT);
            
                Sp_corrK = contract(Sp_corr_Left,'!1',NRGDATA.AK,'!2');
                Sp_corrK = contract(Sp_corrK,conj(Wilson_sp));
                Sp_corrK = contract(NRGDATA.AK,'!2*',Sp_corrK);

                Orb_corrT = contract(Orb_corr_Left,'!1',NRGDATA.AT,'!2');
                Orb_corrT = contract(Orb_corrT,Wilson_orb_z);
                Orb_corrT = contract(NRGDATA.AT,'!2*',Orb_corrT);
            
                Orb_corrK = contract(Orb_corr_Left,'!1',NRGDATA.AK,'!2');
                Orb_corrK = contract(Orb_corrK,Wilson_orb_z);
                Orb_corrK = contract(NRGDATA.AK,'!2*',Orb_corrK);


                Sp_corr{site+1} = 0;
                corrT = contract(Sp_corrT, diag(NRGDATA.RhoT));
                corrK = contract(Sp_corrK, NRGDATA.RhoK);
                ...
                Orb_corr{site+1} = 0;
                corrT = contract(Orb_corrT, diag(NRGDATA.RhoT));
                corrK = contract(Orb_corrK, NRGDATA.RhoK);
                ...
                Sp_corr_Left = contract(Sp_corr_Left,'!1',NRGDATA.AK);
                Sp_corr_Left = contract(NRGDATA.AK,'!2*',Sp_corr_Left,[1,3,2]);

                Orb_corr_Left = contract(Orb_corr_Left,'!1',NRGDATA.AK);
                Orb_corr_Left = contract(NRGDATA.AK,'!2*',Orb_corr_Left,'!2');
