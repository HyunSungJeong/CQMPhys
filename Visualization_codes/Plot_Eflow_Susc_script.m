...
FitInfo.Imp{1}.Range = [-19.5, -18.5;
                        -17,-14;
                        -12.4, -9];
FitInfo.Imp{1}.LineShift = [4, 1/6, 4];
FitInfo.Imp{1}.TextShift = [-0.2, 2.5;
                            -0.2, -3;
                            -1.5, 2.3;];
FitInfo.Imp{2}.Range = [-18,-15;
                         -10.5, -7];
FitInfo.Imp{2}.LineShift = [4, 4];
FitInfo.Imp{2}.TextShift = [-0.2, 2.2;
                             -0.2, 2.5];
FitInfo.Imp{3}.Range = [-18,-15;
                        -12.4, -9];
FitInfo.Imp{3}.LineShift = [4, 1/4];
FitInfo.Imp{3}.TextShift = [-0.2, 2.2;
                            -1.5, -4];

FitInfo.Bath{1}.Range = [-19.5, -18.5;
                         -17.5,-14.5;
                         -9.5,-6];
FitInfo.Bath{1}.LineShift = [4, 4, 4];
FitInfo.Bath{1}.TextShift = [-0.2, 2.5;
                             -0.2, 3;
                             0, 2];
FitInfo.Bath{2}.Range = [-18,-14;
                         -8.5, -5];
...
FitInfo.Bath{2}.TextShift = [-0.2, 2;
                             -0.2, 2];
FitInfo.Bath{3}.Range = [-18, -15;
                         -12,-8];
FitInfo.Bath{3}.LineShift = [4, 1/4];
FitInfo.Bath{3}.TextShift = [-0.2, 2;
                             0, -3];
...
NRG_RGflow_fig(0.3, 0, 1e-6, FitInfo, 'YLims', YLims, 'SubFig_idx', SubFig_idx, 'alphaz', alphaz);



%% (J0, K0, I0) == (0.3, 1e-2, 0)

FitInfo.Imp{1}.Range = [-17, -13];
FitInfo.Imp{1}.LineShift = [6];
FitInfo.Imp{1}.TextShift = [-0.2, 3];
FitInfo.Imp{2}.Range = [-17,-13];
FitInfo.Imp{2}.LineShift = [4];
FitInfo.Imp{2}.TextShift = [-0.2, 2.2];
FitInfo.Imp{3}.Range = [-17,-13];
FitInfo.Imp{3}.LineShift = [1/6];
FitInfo.Imp{3}.TextShift = [-0.2, -4];

FitInfo.Bath{1}.Range = [-17, -13];
FitInfo.Bath{1}.LineShift = [1/6];
FitInfo.Bath{1}.TextShift = [-0.2, -4];
FitInfo.Bath{2}.Range = [-16,-12];
FitInfo.Bath{2}.LineShift = [4];
FitInfo.Bath{2}.TextShift = [-0.2, 2];
FitInfo.Bath{3}.Range = [-10, -8];
FitInfo.Bath{3}.LineShift = [4];
FitInfo.Bath{3}.TextShift = [0, 3];
...
NRG_RGflow_fig(0.3, 1e-2, 0, FitInfo, 'YLims', YLims, 'SubFig_idx', SubFig_idx, 'alphaz', alphaz);





%% (J0, K0, I0) == (0.3, 1e-2, 1e-6)


FitInfo.Imp{1}.Range = [-19.7, -18.2;
                        -17,-14;
                        -9.5,-6];
FitInfo.Imp{1}.LineShift = [5, 1/6, 5];
FitInfo.Imp{1}.TextShift = [-0.4, 2.5;
                            -0.2, -2.7;
                             1, 2.7];
FitInfo.Imp{2}.Range = [-19,-15;
                        -12, -9.5;
                        -5, -2];
FitInfo.Imp{2}.LineShift = [5, 5, 1/6];
FitInfo.Imp{2}.TextShift = [-0.4, 2.5;
                             -0.2, 2.5;
                              -2, -3.5];
FitInfo.Imp{3}.Range = [-19,-15;
                        -12.5, -8];
FitInfo.Imp{3}.LineShift = [5, 1/6];
FitInfo.Imp{3}.TextShift = [-0.2, 2.5;
                            -0.2, -4];


FitInfo.Bath{1}.Range = [-19.7, -18.2;
                         -17,-14.5;
                         -9.5,-6];
FitInfo.Bath{1}.LineShift = [5, 5, 4];
FitInfo.Bath{1}.TextShift = [-0.4, 2.5;
                             -0.5, 3;
                             -0.8, 1.8];
FitInfo.Bath{2}.Range = [-19,-15;
                         -12.5, -9.5;
                         -7.5, -5;
                         -4, -2];
FitInfo.Bath{2}.LineShift = [5, 1/6, 1/6, 5];
FitInfo.Bath{2}.TextShift = [-0.2, 2;
                             -2, -2;
                             -1, -3.7;
                             -1.2, 1.5];
FitInfo.Bath{3}.Range = [-17, -14.5;
                         -12,-8];
FitInfo.Bath{3}.LineShift = [5, 5];
FitInfo.Bath{3}.TextShift = [-0.4, 2.2;
                             0, 2];
...
NRG_RGflow_fig(0.3, 1e-2, 1e-6, FitInfo, 'YLims', YLims, 'SubFig_idx', SubFig_idx, 'alphaz', alphaz);

%% (J0, K0, I0) == (0.3, 1e-3, 1e-6)
...
FitInfo.Bath{2}.Range = [-19,-15;
                         -12, -8;
                         -5, -2];
FitInfo.Bath{2}.LineShift = [5, 1/6, 5];
FitInfo.Bath{2}.TextShift = [-0.2, 2;
                             -1.5, -3.5;
                             -1, 1.5];
FitInfo.Bath{3}.Range = [-17, -14.5;
...
NRG_RGflow_fig(0.3, 1e-3, 1e-6, FitInfo, 'YLims', YLims, 'SubFig_idx', SubFig_idx, 'alphaz', alphaz);

%% (J0, K0, I0) == (1e-4, 0.3, 1e-6)
...
NRG_RGflow_fig(0.3, 1e-4, 1e-6, FitInfo, 'YLims', YLims, 'SubFig_idx', SubFig_idx, 'alphaz', alphaz);

%% (J0, K0, I0) == (0.3, 1e-5, 1e-6)
...
NRG_RGflow_fig(0.3, 1e-5, 1e-6, FitInfo, 'YLims', YLims, 'SubFig_idx', SubFig_idx, 'alphaz', alphaz);


%% (J0, K0, I0) == (0.3, 1e-5, 1e-4)
...
NRG_RGflow_fig(0.3, 1e-5, 1e-4, FitInfo, 'YLims', YLims, 'SubFig_idx', SubFig_idx, 'alphaz', alphaz);


%% (J0, K_perp, K_z, I0) = (0.3, 0.1, -0.15, 0)

FitInfo.Imp{1}.Range = [-17, -13];
FitInfo.Imp{1}.LineShift = [1/4];
FitInfo.Imp{1}.TextShift = [-0.2, -3];
FitInfo.Imp{2}.Range = [-14, -9];
FitInfo.Imp{2}.LineShift = [4];
FitInfo.Imp{2}.TextShift = [-0.2, 2.2];
FitInfo.Imp{3}.Range = [-17,-13];
FitInfo.Imp{3}.LineShift = [1/4];
FitInfo.Imp{3}.TextShift = [-1.7, -3.2];

FitInfo.Bath{1}.Range = [-17, -13];
FitInfo.Bath{1}.LineShift = [1/4];
FitInfo.Bath{1}.TextShift = [-0.2, -3];
FitInfo.Bath{2}.Range = [-14, -9];
FitInfo.Bath{2}.LineShift = [4];
FitInfo.Bath{2}.TextShift = [-0.2, 2.2];
FitInfo.Bath{3}.Range = [-17,-13];
FitInfo.Bath{3}.LineShift = [1/4];
FitInfo.Bath{3}.TextShift = [-1.7, -3];
